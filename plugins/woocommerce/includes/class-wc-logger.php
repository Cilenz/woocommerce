	...
	public function log( $level, $message, $context = array() ) {
		...
		if ( $this->should_handle( $level ) ) {
			...
			foreach ( $this->handlers as $handler ) {
				 ...
				 */
				$handler_message = apply_filters( 'woocommerce_logger_log_message', $message, $level, $context, $handler );

				if ( null !== $handler_message ) {
					$handler->handle( $timestamp, $level, $handler_message, $context );
				}
			}
		}
	}
